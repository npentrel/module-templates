...
import (
    ...
    "github.com/viam-labs/module-templates/powersensor"
)

func main() {
    // NewLoggerFromArgs will create a logging.Logger at "DebugLevel" if
    // "--log-level=debug" is an argument in os.Args and at "InfoLevel" otherwise.
    utils.ContextualMain(mainWithArgs, module.NewLoggerFromArgs("testpowersensor"))
}
        ...
        Components: []resource.Config{
            {
                Name:  os.Args[1],
                API:   powersensor.API,
                Model: custompowersensor.Model,
                Attributes: rdkutils.AttributeMap{
                    "one": arg_2_converted,
                    "two": os.Args[3],
                },
                ConvertedAttributes: &custompowersensor.Config{
