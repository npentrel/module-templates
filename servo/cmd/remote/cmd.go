...
import (
    ...
    "github.com/viam-labs/module-templates/servo"
)

func main() {
    // NewLoggerFromArgs will create a logging.Logger at "DebugLevel" if
    // "--log-level=debug" is an argument in os.Args and at "InfoLevel" otherwise.
    utils.ContextualMain(mainWithArgs, module.NewLoggerFromArgs("testservo"))
}
        ...
        Components: []resource.Config{
            {
                Name:  os.Args[1],
                API:   servo.API,
                Model: customservo.Model,
                Attributes: rdkutils.AttributeMap{
                    "one": arg_2_converted,
                    "two": os.Args[3],
                },
                ConvertedAttributes: &customservo.Config{
